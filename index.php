...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
						Classic Italian Pizza with Cherry Tomatoes and Basil Leaves </br>
						pair your flavorful burger with a fresh and crisp salad.
						</p>
	...
	<section class="our_menus" id="menus">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">EXPLORE OUR MENUS</h2>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>Farah's Pizza is a family-owned restaurant specializing in traditional and gourmet pizzas.
                        </p>
                        <h3>
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="contact-form">
                        <div id="contact_ajax_form" class="contactForm">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button id="contact_send" class="bttn_style_2">Submit Message</button>
                                </div>
                            </div>
                            <div id="sending_load" style="display: none;">Submiting...</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <p>
						Our restaurant stands among the finest, offering delectable menus and dishes. Whether you prefer to reserve a table or indulge in our flavorful offerings through food delivery, we cater to your culinary desires.
                        </p>
                        <ul class="widget_social">
                            <li><a href="https://web.facebook.com/farah.rafah.180/" data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook-f fa-2x"></i></a></li>
                            <li><a href="RAHALIFARAH1" data-toggle="tooltip" title="Twitter"><i class="fab fa-twitter fa-2x"></i></a></li>
                            <li><a href="https://www.instagram.com/rafahfarah?igsh=YzljYTk1ODg3Zg==" data-toggle="tooltip" title="Instagram"><i class="fab fa-instagram fa-2x"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/farah-rahali-804814234" data-toggle="tooltip" title="LinkedIn"><i class="fab fa-linkedin fa-2x"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 11:00am - 3:00pm</li>
                            <li>Monday - Friday 11:00am - 3:00pm</li>
                            <li>Monday - Friday 11:00am - 3:00pm</li>
                            <li>Monday - Friday 11:00am - 3:00pm</li>
							<li>Monday - Friday 11:00am - 3:00pm</li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <h3>Follow Us for Our Latest Content</h3>
