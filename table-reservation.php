...
?>
    ...
    <section style="
    background: url(Design/images/reserver.jfif);
    background-position: center bottom;
    background-repeat: no-repeat;
    background-size: cover;">
        <div class="layer">
            <div style="text-align: center;padding: 15px;">
                <h1 style="font-size: 120px; color: white;font-family: 'Roboto'; font-weight: 100;">Make a Reservation</h1>
            </div>
        </div>
        ...
        ?>
            ...
            <form method="POST" action="table-reservation.php">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="number_of_guests">Total number of people?</label>
                            <select class="form-control" name="number_of_guests">
                                ...
                                <option value="6" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Sex people</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="check_availability" style="visibility: hidden;">Verify Availability</label>
    ...
    <section class="restaurant_details" style="background: url(Design/images/food2.jfif);
    background-repeat: no-repeat;
